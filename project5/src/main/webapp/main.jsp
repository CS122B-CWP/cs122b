...
<link rel="stylesheet" href="/fabflix/CSS/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" href="/fabflix/CSS/common1.css">
<!--[if lt IE 9]>
...
<script src="/fabflix/CSS/bootstrap/js/bootstrap.min.js"></script>
<title>Main</title>
</head>
<body>
	<div id="header"></div>
	<script>
		$("#header").load("/fabflix/FRAGMENT/header.jsp");
	</script>
	...
	<div class="container FX-body">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<div class="span7 text-center pre">
						<a href="/fabflix/singlemovie?id=492001"> <img
				...
				<div class="item">
					<div class="span7 text-center pre">
						<a href="/fabflix/singlemovie?id=671014"> <img
		...
		<div class="row">
			<div class="col-md-6 FX-centralArea">
				<a href="/fabflix/search.jsp"> <span
					class="glyphicon glyphicon-search FX-browseIcon"></span><br>
					Search
				</a>
			</div>
			<div class="col-md-6 FX-centralArea">
				<a href="/fabflix/browse"> <span
	...
	<div id="footer"></div>
	<script>
		$("#footer").load("/fabflix/FRAGMENT/footer.html");
	</script>
</body>
</html>