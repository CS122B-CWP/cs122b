...
/**
 * A simple cookie manager from http://www.hccp.org/java-net-cookie-how-to.html
 * I copied from the website so that I don't need to use httpClient and still work with httpurlconnection
 *
 * -Yuanfan Peng
 *
...
public class MiniCookieManager {

    static private Map store=new HashMap();
    ...
    static private DateFormat dateFormat= new SimpleDateFormat(DATE_FORMAT);

    public MiniCookieManager() {
     ...
     */
    static public void storeCookies(URLConnection conn) throws IOException {
     ...
     */
    static public void setCookies(URLConnection conn) throws IOException {
    ...
    static private String getDomainFromHost(String host) {
    ...
    static private boolean isNotExpired(String cookieExpires) {
    ...
    static private boolean comparePaths(String cookiePath, String targetPath) {
        if (cookiePath == null) {
            return true;
    ...
    public static void main(String[] args) {
        MiniCookieManager cm = new MiniCookieManager();
        try {
            URL url = new URL("http://www.hccp.org/test/cookieTest.jsp");
            URLConnection conn = url.openConnection();
            conn.connect();
