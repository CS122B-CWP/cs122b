	...
	<div class="container FX-body">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<center class="text-warning">Thank you for your purchase! Your products will be shipped as soon as they are ready.</center>
				<center class="text-default">Your account has made the following purchases to date (lists all purchases):</center>
				<!-- <div class="row">
